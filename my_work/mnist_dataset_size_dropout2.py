...
def mnist_dataset_size(nb_weight_updates=120000):
    ...
    for dataset_size in [100, 500, 1000, 5000, 10000, 30000, 60000]:
        ...
        model1 = define_single_layer_mlp((X_train.shape[1], ), 0.2, 2, 2048, 0.5, maxnorm(2),
                                        False)
        model2 = define_single_layer_mlp((X_train.shape[1], ), 0.2, 2, 2048, 0.5, maxnorm(2),
                                        True, 10, 0)
        model3 = define_single_layer_mlp((X_train.shape[1], ), 0.2, 2, 2048, 0.5, maxnorm(2),
                                        True, 10, 0.5)
...
f = open('histories_2x2048_2.pkl', 'wb')
