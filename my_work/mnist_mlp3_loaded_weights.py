...
model.load_weights('./weights/weights_mlp3_adadelta_modified.h5')

score = model.evaluate(X_test, Y_test, show_accuracy=True, verbose=0)

prediction = model.predict_classes(X_test, verbose=1)

scipy.io.savemat('./predictions/predictions_mlp3_adadelta_loaded.mat', mdict={'prediction': prediction})
