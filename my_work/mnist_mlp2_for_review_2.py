...
model.add(Activation('relu'))
model.add(Dropout(0.5))
model.add(Dense(2140, W_constraint=maxnorm(2)))
model.add(Activation('relu'))
model.add(Dropout(0.5))
...
model.save_weights('weights_2048x2_2140_10_for_review.h5', overwrite=True)

f = open('history_2048x2_2140_10_for_review.save', 'wb')
