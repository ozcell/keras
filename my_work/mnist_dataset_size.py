...
for dataset_size in [100, 500, 1000, 5000, 10000, 30000, 60000]:
    nb_epoch = 120000/(dataset_size/batch_size)

    model1 = define_single_layer_mlp((X_train.shape[1], ), 0, 1, 256, 0, None,
                                    False)
    model2 = define_single_layer_mlp((X_train.shape[1], ), 0, 1, 256, 0, None,
                                    True, 10, 0)
