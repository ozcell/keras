...
def mnist_dataset_size(nb_weight_updates=120000):
    ...
    for dataset_size in [100, 500, 1000, 5000, 10000, 30000, 60000]:
        ...
        model1 = define_single_layer_mlp((X_train.shape[1], ), 0, 1, 2048, 0, None,
                                        False)
        model2 = define_single_layer_mlp((X_train.shape[1], ), 0, 1, 2048, 0, None,
                                        True, 10, 0)
        model3 = define_single_layer_mlp((X_train.shape[1], ), 0, 1, 2048, 0, None,
                                        True, 10, 0.5)
