...
model.add(Dense(160, W_constraint=maxnorm(2)))
model.add(Activation('relu'))
model.add(Dropout(0.5))
...
model.save_weights('weights_cnn1_2.h5', overwrite=True)

prediction = model.predict_classes(X_test, verbose=1)

scipy.io.savemat('predictions_cnn1_2.mat', mdict={'prediction': prediction})
