...
model.save_weights('weights_cnn_1024_100_050_no_maxnorm.h5', overwrite=True)

f = open('history_cnn_1024_100_050_no_maxnorm.save', 'wb')
cPickle.dump(results, f, protocol=cPickle.HIGHEST_PROTOCOL)
f.close()

#prediction = model.predict_classes(X_test, verbose=1)
#scipy.io.savemat('predictions_cnn_1024_100_0.50.mat', mdict={'prediction': prediction})
